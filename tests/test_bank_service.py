...
def test_transfer_between_my_accounts_rejects_when_destination_not_owned(
    ...
    monkeypatch.setattr(bank_service, "BankAccountRepository", FakeBankAccountRepository)
...
def test_transfer_between_my_accounts_succeeds(monkeypatch) -> None:
    ...
    class FakeBankAccountRepository:
        ...
        def transfer_between_accounts(self, *, source_account_id, destination_account_id, amount):
            calls["transfer"] = {
