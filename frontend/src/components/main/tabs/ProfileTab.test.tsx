...
describe("ProfileTab", () => {
  it("renders the heading", () => {
    render(<AppProvider><ProfileTab /></AppProvider>);
  ...
  it("shows the user's email when set", () => {
    ...
    const Wrapper = () => {
      ...
      React.useEffect(() => { setEmail("test@example.com"); }, []);
      return <ProfileTab />;
    };
    render(<AppProvider><Wrapper /></AppProvider>);
  ...
  it("shows the connected bank name when a bank is set", () => {
    const Wrapper = () => {
      ...
      React.useEffect(() => { connectBank("Mane-zo"); }, []);
      return <ProfileTab />;
    };
    render(<AppProvider><Wrapper /></AppProvider>);
  ...
  it("clicking Log Out resets onboarding state", () => {
    const IsOnboardedDisplay = () => {
      ...
      React.useEffect(() => { completeOnboarding(); }, []);
      return (
        <>
    ...
    render(<AppProvider><IsOnboardedDisplay /></AppProvider>);
